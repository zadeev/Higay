...
class BandsControllerTest < ActionController::TestCase
  ...
  test "should create band" do
    assert_difference('Band.count') do
      post :create, band: { description: @band.description, genre: @band.genre, logo: @band.logo, title: @band.title }
    end
  ...
  test "should update band" do
    patch :update, id: @band, band: { description: @band.description, genre: @band.genre, logo: @band.logo, title: @band.title }
    assert_redirected_to band_path(assigns(:band))
  end
